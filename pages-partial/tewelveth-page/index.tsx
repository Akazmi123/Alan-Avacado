    ...
    <>
      <div className="w-full h-[100vh] relative xs:block hidden">
        ...
        <div className="absolute bottom-[8vh] left-[8vw] w-[40vh] proza text-[#7B695A] text-[1.7vh]">
          ...
          <br />
          <br />
          <span className="proza-bold">200 ml</span> spray — a modern solution
          for light dosing. Perfect for grilling, roasting vegetables, or adding
          just the right touch to salads. <br />
          <br />
      ...
      <div className="w-full xs:hidden block">
        <div className="bg-[#E5F0F3] w-[80%] flex justify-start items-end p-10 mb-10">
        ...
        <div className="w-[90%] mx-auto text-[16px] proza text-[#7B695A] mb-10">
          <span className="opacity-0">fffffff</span>We made sure our avocado oil
          is convenient to use in any situation. That’s why we offer several
          packaging formats: <br />
          <br />
          250 ml glass bottle — a compact option for everyday use, first-time
          tasting, or as a gift. <br />
          <br />
          750 ml glass bottle — the family-sized format for those who cook often
          and use oil regularly. <br />
          <br />
          200 ml spray — a modern solution for light dosing. Perfect for
          grilling, roasting vegetables, or adding just the right touch to
          salads. <br />
          <br />
          Each bottle is made of dark glass or aluminum to protect the oil from
          sunlight and keep it fresh longer.

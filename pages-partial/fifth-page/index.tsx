    ...
    <div className="w-full h-[100vh] relative">
      ...
      <div className="bg-[#CADBB7] px-10 w-[25%] h-[80vh] absolute bottom-0 left-[50%] -translate-x-1/2 flex justify-center items-start">
        <div className="w-full h-full relative">
          <div className="w-full pt-15 text-[8vh] playfair-italic text-[#3C210E]">
            Color and <br />
            Flavor That <br />
            Speak for
            <br /> Themselves
      ...
      <div className="Proza text-[#7B695A] text-[2.2vh] absolute top-1/2 right-10 -translate-y-1/2 w-[25vw]">
        <div>
          {" "}

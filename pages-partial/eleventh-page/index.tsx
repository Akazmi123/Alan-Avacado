    ...
    <div className="w-full h-[100vh] relative flex justify-center items-center gap-10">
      <div className="">
        {[1, 2, 3].map((_, index) => (
          <div
            key={index}
            className="max-w-[600px] rounded-lg p-5 mb-4"
            style={{
          ...
          >
            <div className="flex justify-between items-start">
              ...
              <div className="flex flex-col justify-between items-start gap-5">
                ...
                <div className="proza text-[12px] text-[#3C210E] bg-[#CADBB7] px-6 py-1 rounded-full">
                  Buy Now
                </div>
              </div>
            </div>
      ...
      <div className="w-[20%] rounded-lg border-[4px solid #E5F0F3] shadow-lg p-5">
        <div className="flex flex-col justify-between items-start">
          <div className="w-full h-[267px] relative">

...
export const ThirdPage = () => {
  return (
    <div className="w-full xs:h-[100vh] h-[130vh] relative xs:block flex xs:flex-row flex-col justify-end items-center">
      ...
      <div className="w-[90%] mx-auto text-[#7B695A] text-[2.3vh] xs:hidden block">
        <span className="opacity-0">fffffff</span>Not all avocados make it to
        market. Many are rejected for their size or shape: too big, too small,
        or simply with “character.” Yet their taste and nutritional value remain
        unchanged. Instead of wasting this harvest, we decided to give these
        fruits a new life.
        <br />
        <span className="opacity-0">fffffff</span>This is how our project began
        — turning these avocados into cold-pressed oil.
      </div>

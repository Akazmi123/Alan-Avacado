    ...
    <>
      <div className="w-full h-[100vh] relative xs:block hidden">
        ...
        <div className="Proza xs:w-[25vw] w-[90%] text-[#7B695A] text-[2.2vh] absolute xs:left-auto left-1/2 bottom-10 xs:bottom-auto xs:top-1/2 right-10 xs:-translate-x-0 -translate-x-1/2 -translate-y-1/2">
          <div>
            ...
            This flavor doesn’t overpower dishes but enhances them. From salads
            to sautéed vegetables or meats, the oil becomes part of your cooking
      ...
      <div className="w-full xs:hidden block">
        ...
        <div className="w-[90%] mx-auto text-[16px] text-[#7B695A] proza mb-20">
          <span className="opacity-0">fff</span> After pressing, the oil takes
          on its signature greenish tint — a sign that the product is unrefined
          and has retained its natural pigments. Unlike neutral-tasting oils,
          our avocado oil keeps the rich flavor of fresh avocado. <br />
          <br />
          <span className="opacity-0">fff</span>
